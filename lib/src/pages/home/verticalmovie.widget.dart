...
class VerticalMovieWidge extends StatelessWidget {
  final Stream<List<VehicleEntity>> listMovieFlux;
          ...
          Container(
            ...
            child: StreamBuilder(
                ...
                builder: (BuildContext context, AsyncSnapshot snapshot) {
                  ...
                  List<VehicleEntity> vehicles = snapshot.data;
                  print(vehicles);
                  print(snapshot.data);
                  return listView(vehicles);
                }),
          ),
        ],
      ),
  ...
  listView(List<VehicleEntity> movies) => ListView.builder(
          ...
          return Container(
            ...
            child: ClipRRect(
              ...
              child: FadeInImage.assetNetwork(
                ...
                fit: BoxFit.cover,
                image: movies[index].VehicleImage.Url,
              ),
            ),
          );
        },
